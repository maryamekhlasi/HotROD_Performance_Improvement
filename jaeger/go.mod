...
require (
	...
	github.com/loicgelle/jaeger-go-lttng-instr v0.0.0-20190710150916-50c3ed10e0aa // indirect
...
replace github.com/uber/jaeger-client-go => /home/maryam/Poly/Dorsal/git/secondRevision/arnaud2/jaeger/examples/hotrod/jaeger-client-go
